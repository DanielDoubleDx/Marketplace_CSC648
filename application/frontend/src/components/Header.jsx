        ...
        <div className="flex items-center space-x-4 relative">
          <div className="relative group">
            ...
            <input
              type="text"
              placeholder="Search"
              className="absolute right-8 top-1/2 -translate-y-1/2 w-60 px-3 py-2 rounded-md bg-gray-900 text-white border border-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out"
            />
          </div>
